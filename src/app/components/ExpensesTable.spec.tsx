...
describe('ExpensesTable component', () => {
  ...
  it('renders the table with expenses data', () => {
    render(<ExpensesTable expenses={mockExpenses} isHighestExpense={() => false} handleCheckboxChange={() => {}} />)
  ...
  it('renders empty state when no expenses provided', () => {
    render(<ExpensesTable expenses={[]} isHighestExpense={() => false} handleCheckboxChange={() => {}} />)
